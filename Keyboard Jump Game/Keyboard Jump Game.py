...
background = pygame.image.load("Keyboard Jump Game\keyback.jpg")
background = pygame.transform.scale(background, (WIDTH, HEIGHT))  #scale image 

font = pygame.font.Font('Keyboard Jump Game\comic.ttf', 40)
...
def new_word():
    ...
    word_speed += 0.10
    yourword = ''
    words = open("Keyboard Jump Game\words.txt").read().split(', ')
    displayword = random.choice(words)
new_word()

font_name = pygame.font.match_font('Keyboard Jump Game\comic.ttf')
...
while True:
    ...
    background = pygame.image.load('Keyboard Jump Game\gamebackground.jpg')
    background = pygame.transform.scale(background, (WIDTH, HEIGHT))
    character = pygame.image.load('Keyboard Jump Game\char.jpg')
    character = pygame.transform.scale(character, (50,50))
    wood = pygame.image.load('Keyboard Jump Game\wood-.png')
