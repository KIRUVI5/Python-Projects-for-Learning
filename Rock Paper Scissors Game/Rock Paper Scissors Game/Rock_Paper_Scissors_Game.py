...
comp_pick = random.randint(1,3) # return a random number between 1 and 3
if comp_pick == 1:
    comp_pick = 'rock'
elif comp_pick ==2:
    comp_pick = 'paper'
...
Button(root, font = 'arial 13 bold', text = 'PLAY'  ,padx =5,bg ='seashell4' ,command = playGame).place(x=150,y=190)
